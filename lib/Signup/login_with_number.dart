          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Text(
                    'Remember Me' , style: TextStyle(fontWeight: FontWeight.bold),),
              ],
            ),
            SizedBox(height: 20,),
            Padding(
            ...
            Container(
              child: Row(crossAxisAlignment: CrossAxisAlignment.center,
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text("Don't have an account?" , style: TextStyle(color: Onboarolors.greyboarder),),
